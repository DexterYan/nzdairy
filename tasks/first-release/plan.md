...
Status: implementation complete; launch gates remain open in [`todo.md`](todo.md).

The authoritative product and implementation plan is in [`docs/implementation-plan.md`](../../docs/implementation-plan.md). The executable checklist is in [`todo.md`](todo.md).
